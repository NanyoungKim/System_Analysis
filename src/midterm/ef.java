...
public class ef extends ViewableDigraph
{
	...
	public ef()
	{
		this("ef", 15, 1000);	//int_arr_t은 genr / observe_t는 transd
	}
	...
	public ef(String name, double int_arr_t, double observe_t)	//이 함수 코드 외워야함!!!!!! (시험)
	{
	    ...
	    ViewableAtomic g = new genrFire("genrFire",int_arr_t);
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("genrFire")).setPreferredLocation(new Point(36, 52));
        ((ViewableComponent)withName("transd")).setPreferredLocation(new Point(207, 131));
    }
}
