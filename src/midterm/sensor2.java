...
public class sensor2 extends ViewableAtomic
{
	...
	public sensor2(String name, double Processing_time)
	{
		super(name);
	...
	public void deltext(double e, message x)
	{
		...
		if (phaseIs("passive"))
		{
			for (int i = 0; i < x.size(); i++)
			{
				...
				//	System.out.println("sensor 2 : " + c_f.sensorLocation);
					
					isOn = false;	//초기화 
					if(c_f.sensorLocation == 2) {	//sensor1로 들어온거
